...
typedef enum {
  ...
  GLFW_FKEY_KP_SEPARATOR = 0xe048,
  GLFW_FKEY_KP_LEFT = 0xe049,
  GLFW_FKEY_KP_RIGHT = 0xe04a,
  GLFW_FKEY_KP_UP = 0xe04b,
  GLFW_FKEY_KP_DOWN = 0xe04c,
  GLFW_FKEY_KP_PAGE_UP = 0xe04d,
  GLFW_FKEY_KP_PAGE_DOWN = 0xe04e,
  GLFW_FKEY_KP_HOME = 0xe04f,
  GLFW_FKEY_KP_END = 0xe050,
  GLFW_FKEY_KP_INSERT = 0xe051,
  GLFW_FKEY_KP_DELETE = 0xe052,
  GLFW_FKEY_LEFT_SHIFT = 0xe053,
  GLFW_FKEY_LEFT_CONTROL = 0xe054,
  GLFW_FKEY_LEFT_ALT = 0xe055,
  GLFW_FKEY_LEFT_SUPER = 0xe056,
  GLFW_FKEY_RIGHT_SHIFT = 0xe057,
  GLFW_FKEY_RIGHT_CONTROL = 0xe058,
  GLFW_FKEY_RIGHT_ALT = 0xe059,
  GLFW_FKEY_RIGHT_SUPER = 0xe05a,
  GLFW_FKEY_MEDIA_PLAY = 0xe05b,
  GLFW_FKEY_MEDIA_PAUSE = 0xe05c,
  GLFW_FKEY_MEDIA_PLAY_PAUSE = 0xe05d,
  GLFW_FKEY_MEDIA_REVERSE = 0xe05e,
  GLFW_FKEY_MEDIA_STOP = 0xe05f,
