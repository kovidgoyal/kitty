...
typedef enum {
  ...
  GLFW_FKEY_LEFT_SHIFT = 0xe053u,
  GLFW_FKEY_LEFT_CONTROL = 0xe054u,
  GLFW_FKEY_LEFT_ALT = 0xe055u,
  GLFW_FKEY_LEFT_SUPER = 0xe056u,
  GLFW_FKEY_RIGHT_SHIFT = 0xe057u,
  GLFW_FKEY_RIGHT_CONTROL = 0xe058u,
  GLFW_FKEY_RIGHT_ALT = 0xe059u,
  GLFW_FKEY_RIGHT_SUPER = 0xe05au,
  GLFW_FKEY_MEDIA_PLAY = 0xe05bu,
  GLFW_FKEY_MEDIA_PAUSE = 0xe05cu,
  GLFW_FKEY_MEDIA_PLAY_PAUSE = 0xe05du,
  GLFW_FKEY_MEDIA_REVERSE = 0xe05eu,
  GLFW_FKEY_MEDIA_STOP = 0xe05fu,
  GLFW_FKEY_MEDIA_FAST_FORWARD = 0xe060u,
  GLFW_FKEY_MEDIA_REWIND = 0xe061u,
  GLFW_FKEY_MEDIA_TRACK_NEXT = 0xe062u,
  GLFW_FKEY_MEDIA_TRACK_PREVIOUS = 0xe063u,
  GLFW_FKEY_MEDIA_RECORD = 0xe064u,
  GLFW_FKEY_LOWER_VOLUME = 0xe065u,
  GLFW_FKEY_RAISE_VOLUME = 0xe066u,
  GLFW_FKEY_MUTE_VOLUME = 0xe067u,
  GLFW_FKEY_LAST = 0xe067u
} GLFWFunctionKey;
