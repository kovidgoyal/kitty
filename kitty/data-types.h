...
typedef enum UnfocusedCursorShapes { UNFOCUSED_NO_CURSOR_SHAPE, UNFOCUSED_CURSOR_BLOCK, UNFOCUSED_CURSOR_BEAM, UNFOCUSED_CURSOR_UNDERLINE, UNFOCUSED_CURSOR_AUTO, NUM_OF_UNFOCUSED_CURSOR_SHAPES } UnfocusedCursorShape;
