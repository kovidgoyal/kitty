...
o('tab_bar_style', 'fade', option_type=choices('fade', 'separator', 'hidden', 'powerline'), long_text=_('''
The tab bar style, can be one of: :code:`fade`, :code:`separator`, :code:`hidden` or :code:`powerline`. In the fade style,
each tab's edges fade into the background color, in the separator style, tabs are
separated by a configurable separator, in hidden style tabs are invisible, in powerline style tabs are rendered in powerline style.
'''))
