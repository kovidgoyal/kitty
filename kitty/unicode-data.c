...
is_combining_char(char_type code) {
	// M category (marks) (2238 codepoints) {{{
	switch(code) {
		case 0x300 ... 0x36f:
			return true;
		case 0x483 ... 0x489:
...
is_ignored_char(char_type code) {
	// Control characters and non-characters (2331 codepoints) {{{
	switch(code) {
		case 0x0 ... 0x1f:
			return true;
		case 0x7f ... 0x9f:
...
combining_type mark_for_codepoint(char_type c) {
	switch(c) { // {{{
		...
		case 72193: case 72194: case 72195: case 72196: case 72197: case 72198: case 72199: case 72200: case 72201: case 72202: return 1584 + c - 72193;
		case 72243: case 72244: case 72245: case 72246: case 72247: case 72248: case 72249: return 1594 + c - 72243;
		case 72251: case 72252: case 72253: case 72254: return 1601 + c - 72251;
		case 72263: return 1605;
		case 72273: case 72274: case 72275: case 72276: case 72277: case 72278: case 72279: case 72280: case 72281: case 72282: case 72283: return 1606 + c - 72273;
		case 72330: case 72331: case 72332: case 72333: case 72334: case 72335: case 72336: case 72337: case 72338: case 72339: case 72340: case 72341: case 72342: case 72343: case 72344: case 72345: return 1617 + c - 72330;
		case 72751: case 72752: case 72753: case 72754: case 72755: case 72756: case 72757: case 72758: return 1633 + c - 72751;
		case 72760: case 72761: case 72762: case 72763: case 72764: case 72765: case 72766: case 72767: return 1641 + c - 72760;
		case 72850: case 72851: case 72852: case 72853: case 72854: case 72855: case 72856: case 72857: case 72858: case 72859: case 72860: case 72861: case 72862: case 72863: case 72864: case 72865: case 72866: case 72867: case 72868: case 72869: case 72870: case 72871: return 1649 + c - 72850;
		case 72873: case 72874: case 72875: case 72876: case 72877: case 72878: case 72879: case 72880: case 72881: case 72882: case 72883: case 72884: case 72885: case 72886: return 1671 + c - 72873;
		case 73009: case 73010: case 73011: case 73012: case 73013: case 73014: return 1685 + c - 73009;
		case 73018: return 1691;
		case 73020: case 73021: return 1692 + c - 73020;
		case 73023: case 73024: case 73025: case 73026: case 73027: case 73028: case 73029: return 1694 + c - 73023;
		case 73031: return 1701;
		case 73098: case 73099: case 73100: case 73101: case 73102: return 1702 + c - 73098;
		case 73104: case 73105: return 1707 + c - 73104;
		case 73107: case 73108: case 73109: case 73110: case 73111: return 1709 + c - 73107;
		case 73459: case 73460: case 73461: case 73462: return 1714 + c - 73459;
		case 92912: case 92913: case 92914: case 92915: case 92916: return 1718 + c - 92912;
		case 92976: case 92977: case 92978: case 92979: case 92980: case 92981: case 92982: return 1723 + c - 92976;
		case 94033: case 94034: case 94035: case 94036: case 94037: case 94038: case 94039: case 94040: case 94041: case 94042: case 94043: case 94044: case 94045: case 94046: case 94047: case 94048: case 94049: case 94050: case 94051: case 94052: case 94053: case 94054: case 94055: case 94056: case 94057: case 94058: case 94059: case 94060: case 94061: case 94062: case 94063: case 94064: case 94065: case 94066: case 94067: case 94068: case 94069: case 94070: case 94071: case 94072: case 94073: case 94074: case 94075: case 94076: case 94077: case 94078: return 1730 + c - 94033;
		case 94095: case 94096: case 94097: case 94098: return 1776 + c - 94095;
		case 113821: case 113822: return 1780 + c - 113821;
		case 119141: case 119142: case 119143: case 119144: case 119145: return 1782 + c - 119141;
		case 119149: case 119150: case 119151: case 119152: case 119153: case 119154: return 1787 + c - 119149;
		case 119163: case 119164: case 119165: case 119166: case 119167: case 119168: case 119169: case 119170: return 1793 + c - 119163;
		case 119173: case 119174: case 119175: case 119176: case 119177: case 119178: case 119179: return 1801 + c - 119173;
		case 119210: case 119211: case 119212: case 119213: return 1808 + c - 119210;
		case 119362: case 119363: case 119364: return 1812 + c - 119362;
		case 121344: case 121345: case 121346: case 121347: case 121348: case 121349: case 121350: case 121351: case 121352: case 121353: case 121354: case 121355: case 121356: case 121357: case 121358: case 121359: case 121360: case 121361: case 121362: case 121363: case 121364: case 121365: case 121366: case 121367: case 121368: case 121369: case 121370: case 121371: case 121372: case 121373: case 121374: case 121375: case 121376: case 121377: case 121378: case 121379: case 121380: case 121381: case 121382: case 121383: case 121384: case 121385: case 121386: case 121387: case 121388: case 121389: case 121390: case 121391: case 121392: case 121393: case 121394: case 121395: case 121396: case 121397: case 121398: return 1815 + c - 121344;
