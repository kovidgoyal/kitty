...
"""
    ...
    args = RemoteCommand.Args(
        spec='CONF_FILE ...', json_field='paths', completion=RemoteCommand.CompletionSpec.from_string('type:file group:"CONF files", ext:conf')
    )
    ...
    def response_from_kitty(self, boss: Boss, window: Window | None, payload_get: PayloadGetType) -> ResponseType:
        ...
        boss.load_config_file(
            *paths,
            apply_overrides=not payload_get('ignore_overrides', missing=False),
