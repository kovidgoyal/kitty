...
def get_child_window_ids(os_window_id: int, tab_id: int, window_id: int, child_id: int = 0) -> list[int]: ...
def remove_floating_window(os_window_id: int, tab_id: int, non_floating_window_id: int, window_id: int) -> None: ...
def add_floating_window(os_window_id: int, tab_id: int, floating_in: int) -> int: ...
