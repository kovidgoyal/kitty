...
class AmoebaSolver:
    ...
    def add_constraint(self, terms: Sequence[Tuple[int, float]], relation: Literal['==', '<=', '>='], constant: float, strength: float = ...) -> None: ...
    def add_edit_variable(self, variable: int, strength: float) -> None: ...
    def suggest_value(self, variable: int, value: float) -> None: ...
