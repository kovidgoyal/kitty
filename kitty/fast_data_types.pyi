...
def base64_encode(src: ReadableBuffer, add_padding: bool = False) -> bytes: ...
def base64_encode_into(src: ReadableBuffer, output: WriteableBuffer, add_padding: bool = False) -> int: ...
def base64_decode(src: ReadableBuffer) -> bytes: ...
def base64_decode_into(src: ReadableBuffer, output: WriteableBuffer) -> int: ...
